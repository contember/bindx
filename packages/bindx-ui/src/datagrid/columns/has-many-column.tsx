...
import type { RelationFilterContext, RelationCellWrapperContext, RelationColumnComponent, DataGridHasManyColumnProps } from '@contember/bindx-dataview'
...
const _HasManyColumn: RelationColumnComponent = createRelationColumn(hasManyColumnDef, hasManyCellConfig, relationUI)
export const DataGridHasManyColumn: {
	<TEntity, TSelected>(props: DataGridHasManyColumnProps<TEntity, TSelected>): null
	staticRender: typeof _HasManyColumn.staticRender
} = _HasManyColumn
