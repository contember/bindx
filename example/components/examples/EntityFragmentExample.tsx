 ...
 */
export const AuthorInfo = createEntityFragment<AuthorInfoProps>(({ author, showEmail }) => (
 ...
 */
export const AuthorBio = createEntityFragment<AuthorBioProps>(({ author }) => (
 ...
 */
export const ArticleTags = createEntityFragment<ArticleTagsProps>(({ article, className }) => (
